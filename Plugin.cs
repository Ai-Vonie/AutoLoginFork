...
namespace AutoLogin {
    public unsafe class Plugin : IDalamudPlugin {
        ...
        internal ConnectionErrorHandler ConnectionErrorHandler;
        ...
        public Plugin(IDalamudPluginInterface pluginInterface, IToastGui ToastGui) {
            ...
            // Enable connection error handler
            ConnectionErrorHandler.Setup(true, this);
        }
        ...
        public void Dispose()
        {
            ConnectionErrorHandler?.Dispose();
            Framework.Update -= OnFrameworkUpdate;
